...
class RobotInfoPublisher(Node):
    def __init__(self):
        ...
        self.odom_sub_ = self.create_subscription(Odometry, self.robot_id + '/odom', self.odom_callback, 10)
        self.scan_sub_ = self.create_subscription(LaserScan, self.robot_id + '/scan', self.scan_callback, 10)
